...
distances = np.sqrt(np.sum((x_train - x_test)**2, axis=1))  # Jarak Euclidean
...
print(f"Kelas prediksi untuk data uji dengan K = 3 (menggunakan Euclidean) adalah :'{prediction_k3}'.")
...
print(f"Kelas prediksi untuk data uji dengan K = 4 (menggunakan Euclidean) adalah :'{prediction_k4}'.")
...
print(f"Kelas prediksi untuk data uji dengan K = 5 (menggunakan Euclidean) adalah :'{prediction_k5}'.")